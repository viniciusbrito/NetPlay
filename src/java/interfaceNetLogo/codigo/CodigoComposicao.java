/*
 * CodigoComposicao.java
 *
 * Created on 2 de Outubro de 2006, 16:22
 *
 */
...
import cdp.*;
import cgt.AplCadastrarCondicao;
...
public class CodigoComposicao {
    ...
    public CodigoComposicao(Modelo m) 
    {
        modelo = m;
        codigo = "";
        outrasFuncoes = "";
    ...
    private void criaCodigoComposicao()
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if(composicao.getTipo().equals("composicao"))
            {
                codigo += "\t;Composicao " + composicao.getNome() + "\n";
    ...
    private Agente determinaAgentePrincipal (Composicao composicao)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            //Se for tam de agente => agente eh o agente principal
            if (condicao.getTipo().equals("Tam"))
            {
                agentePrincipal = ((Tamanho) condicao).getAgente();
            }
        }
            ...
            String operadorLogico)
    {
        ...
        else
        {
            ...
            {
                if(percepcaoMaiorDistancia.getModo().equals("normal"))
                {
                    if (distancia == 0)
                    {
                        if (agente.getTipo().equals("Movel"))
                ...
                else if(percepcaoMaiorDistancia.getModo().equals("avancado"))
                {
                    if (distancia == 0)
                    {
                        String aux = criaCodigoPercepcaoVariaveis(percepcaoMaiorDistancia.getIdCondicao(), "percebido");
                        String aux2 = criaCodigoPercepcaoCFT(percepcaoMaiorDistancia.getIdCondicao());
                        String aux3 = " ";
                        ...
                        if (agente.getTipo().equals("Movel"))
                            codigo += "\t\t   ### conjunto_" + agente.getNome() + 
                                    "-here with [" + aux + aux3 + aux2 + " ]";
                        else {
                            if(!aux.equals(""))
                                aux3 = " and ";
                            codigo += "\t\t   ### turtles-here " +
                                    "with [ pcolor = " + 
                                    Traducao.cor(agente.getCor()) + aux3 + aux + " ]";
                        }
                    }
                    else
                    {
                        ...
                        if(!aux.equals("") && !aux2.equals(""))
                            aux3 = " and";
                        if (agente.getTipo().equals("Movel"))
                            codigo += "\t\t   ### conjunto_" + agente.getNome() + " with [" +
                                    aux + aux3 + aux2 + " ] in-radius " + distancia;
                        else {
                            if(!aux.equals(""))
                                aux3 = " and ";
                            codigo += "\t\t   ### patches with [ pcolor = " + 
    ...
    private boolean envolveSohAgente (Condicao condicao, Agente agente)
    {
        ...
        //Se for o agente de tam
        if (condicao.getTipo().equals("Tam"))
        {
            if (agente.getNome().equals(((Tamanho) condicao).getAgente().getNome()))
                return true;
        }
    ...
    private Agente agenteEnvolvidoCondicao (Condicao condicao)
    {
        ...
        if (condicao.getTipo().equals("Tam"))
        {
            return ((Tamanho) condicao).getAgente();
        }
        return null;
    }
    ...
    private boolean EnvolveSohAgente(Acao acao, Agente agente)
    {
        ...
        if(acao.getTipo().equals("Mostrar"))
        {
            return ((MostrarAgente) acao).getAgente().getNome().equals(
                    agente.getNome());
        }
        
        if(acao.getTipo().equals("Ocultar"))
        {
            return ((OcultarAgente) acao).getAgente().getNome().equals(
                    agente.getNome());
        }
        
        if(acao.getTipo().equals("AltTam"))
        {
            return ((AlterarTamanho) acao).getAgenteMovel().getNome().equals(
                    agente.getNome());
        }
    ...
    private Agente agenteEnvolvidoAcao (Acao acao)
    {
        ...
        if (acao.getTipo().equals("Mostrar"))
            return ((MostrarAgente) acao).getAgente();
        
        if (acao.getTipo().equals("Ocultar"))
            return ((OcultarAgente) acao).getAgente();
        
        if (acao.getTipo().equals("AltTam"))
            return ((AlterarTamanho) acao).getAgenteMovel();
        return null;
    }
