                                                ...
                                                <th width="190" scope="row"><table width="190" height="20" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                    <tr>
                                                      <td width="20"><div align="center">
                                                          ...
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelparado.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=1'" value="aleatorio" checked>
                                                          <%}else{%>
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelparado.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=1'" value="aleatorio">
                                                          <%}%>
                                                      </div></td>
                                                      <td width="230"><div align="center" class="style1">
                                                ...
                                                <th scope="row"><table width="190" height="20" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                    <tr>
                                                      <td width="20" height="16"><div align="center">
                                                          <%if(posicao == 3){%>
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelparado.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=3'" value="posicaoInicial" checked>
                                                          <%}else{%>
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelparado.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=3'" value="posicaoInicial">
                                                          <%}%>
                                                      </div></td>
                                                      <td width="230"><div align="center" class="style1">
                                          ...
                                          <table width="170" height="5" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                              ...
                                              <td width="70"><table width="70" height="5" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="tipoMovimento" type="radio" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&acao=' + acao.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=<%=posicao%>'" value="Refletir">
                                                    </div></td>
                                              ...
                                              <td width="70"><table width="70" height="5" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="tipoMovimento" type="radio" onclick="window.location.href = 'movelparado.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=<%=posicao%>'" value="Parado" checked>
                                                    </div></td>
