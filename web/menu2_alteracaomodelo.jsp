...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/JavaScript">
            ...
            var nome = '<%= m.getNome()%>';
            var descricao = '<%= m.getDescricao()%>';

            function desabilita()
            {
            if(!document.modelo.alterarVersao.checked)
            {
            document.modelo.nome2.disabled = true;
            document.modelo.descricao.disabled = true;
            document.modelo.nome2.value = nome;
            document.modelo.descricao.value = descricao;
            } 
            else
            {
            document.modelo.nome2.disabled = false;
            document.modelo.descricao.disabled = false;
            }
            }

            function impedir()
            {
            document.modelo.alterarVersao.checked = true;
            }
                                        ...
                                        <table width="180" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#BBD0BF">
                                            ...
                                            <tr>
                                                <td valign="top"><table width="160" height="210" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                        ...
                                                        <tr>
                                                            <td width="150" height="30"><div align="center"><span class="style34"><a href="#" onClick="MM_popupMsg('As inclus&otilde;es desses elementos s&oacute; ser&atilde;o permitidas ap&oacute;s o salvamento das informa&ccedil;&otilde;es do modelo ')">Exportar Modelo</a> </span></div></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table>
                                                ...
                                                <th colspan="4" scope="row"><table width="440" border="1">
                                                        <tr>
                                                            <th scope="row"><table width="440" border="0" cellpadding="0" cellspacing="0" bgcolor="#BBD0BF">
                                                                    <tr>
                                                                        <td><div align="center">
                                                                                <form action="controlador.ControladorWeb" method="post" name="modelo" id="modelo" onSubmit="MM_validateForm('nome2', '', 'R', 'descricao', '', 'R');
                                                                                                        ...
                                                                                                        <td width="340"><div align="center">
                                                                                                                <table width="340" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="220"><input name="nome" type="text" id="nome2" value="<%= m.getNome()%>" size="40" maxlength="30" onChange="javascript:aceitaAscii(nome.value)"></td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td><div align="left">Descri&ccedil;&atilde;o</div></td>
                                                                                                                        <td>
                                                                                                                            <div align="left">
                                                                                                                                <textarea name="descricao" cols="30" rows="3" id="descricao"><%= m.getDescricao()%></textarea>
                                                                                                                            </div></td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td height="30" colspan="2"><div align="left">
                                                                                                                                <label>
                                                                                                                                    <% Usuario u1 = (Usuario) session.getAttribute("usuario");
                                                                                                                                        ...
                                                                                                                                        //Procurando login do usuario que criou o modelo
                                                                                                      String u2Login = AplCadastrarModelo.obterUsuario(m.getNome());

                                                                                                      if (u1.getLogin().equals(u2Login)) { %>
                                                                                                                                    <input name="alterarVersao" type="checkbox" value="checkbox" checked onclick="javascript:desabilita()">
                                                                                                                                    <% } else { %>
                                                                                                                                    <input name="alterarVersao" type="checkbox" value="checkbox" checked onclick="javascript:impedir()">
                                                                                                                                    <% }%>
                                                                                                                                    Alterar Vers&atilde;o do Modelo</label>
                                                                                                                            </div></td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <td height="30" colspan="2"><div align="center">
                                                                                                                                <input name="salvarModelo" type="submit" id="enviar5" value="Alterar Modelo">
                                                                                                                            </div></td>
                                                                                                                    </tr>
                                                                                                                </table>
                                                                                                            </div></td>
                                                                                                        <td width="50"><input name="metodo" type="hidden" value="cadastroModelo">
                                                                                                            <input name="acao" type="hidden" value="incluirNovaVersao"></td>
                                                                                                    </tr>
                                                                                                </table></td>
                                                                                        </tr>
                                                                                    </table>
