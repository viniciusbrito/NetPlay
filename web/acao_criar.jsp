                                ...
                                <td height="103"><div align="center">
                                    <form action="controlador.ControladorWebCCA" method="post" name="acCriar" id="acCriar">
                                        <table width="306" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                            ...
                                            <tr>
                                                <td>Posição</td><td><input type="radio" name="posicao" value="proximo" checked/>Proximo <input type="radio" name="posicao" value="aleatorio"/>Aleatório</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td><div align="center">
                                                    ...
                                                    <input name="op" type="hidden" value="Criar">
