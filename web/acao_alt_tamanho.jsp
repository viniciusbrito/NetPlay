<%-- 
    Document   : acao_alt_tamanho
    Created on : 30/12/2014, 07:11:36
    Author     : vinicius
--%>
...
<%
   ...
   AlterarTamanho acao = (AlterarTamanho) AplCadastrarAcao.obterAcao(Integer.parseInt(id));
    ...
    <body>
        ...
        <div align="center">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="4"><div align="center" class="style38">Alterar Tamanho </div></td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
                                ...
                                <td height="103"><div align="center">
                                    <form action="controlador.ControladorWebCCA" method="post" name="acAltMov" id="acAltMov" onSubmit="MM_validateForm();return document.MM_returnValue">
                                        <table width="306" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                            ...
                                            <tr>
                                                <%
                                                    if(acao.getTipoTamanho().equals("alterar"))
                                                    {
                                                %>
                                                        <td>Tipo</td>
                                                        <td>
                                                            <input type="radio" name="tipoTam" value="alterar" checked/>Alterar
                                                            <input type="radio" name="tipoTam" value="incremental"/>Incrementar
                                                        </td>
                                                <%
                                                    }
                                                    else if(acao.getTipoTamanho().equals("incremental"))
                                                    {
                                                %>
                                                        <td>Tipo</td>
                                                        <td>
                                                            <input type="radio" name="tipoTam" value="alterar"/>Alterar
                                                            <input type="radio" name="tipoTam" value="incremental" checked/>Incrementar
                                                        </td>
                                                <%
                                                    }
                                                %>
                                            ...
                                            <tr>
                                                <td><div align="center">
                                                    ...
                                                    <input name="TipoAcao" type="hidden" id="TipoAcao" value="AltTam">
                                                </div></td>
                                            </tr>
                                            <tr>
