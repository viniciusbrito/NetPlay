...
<div align="center">
  <table width="525" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><div align="center" class="style1">Altera&ccedil;&atilde;o Texto </div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
                            ...
                            <td><div align="center">
                                <table width="400" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                  ...
                                  <tr>
                                    ...
                                    <td><textarea name="Texto" cols="30" rows="3" id="texto2"><%= texto %></textarea></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td colspan="2"><div align="center">
                                      <input name="alterartexto" type="submit" id="alterartexto" value="Alterar Texto">
</div></td>
                                  </tr>
                                </table>
                            </div></td>
