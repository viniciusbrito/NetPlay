                              ...
                              <td><div align="center">
                                  <table width="380" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                    <tr>
                                      ...
                                      <td width="240"><input name="Nome" value="<%=nome%>" type="text" id="Nome4" size="40" maxlength="50"></td>
                                    </tr>
                                    <tr>
                                      <td> <div align="left"></div>
                                      <div align="left">Valor</div></td>
                                      <!--<td><input name="Valor" type="text" id="valor (opcional)" value="0" size="40" maxlength="30"></td> -->
                                      <td><textarea name="Valor" id="valor" cols="30" rows="3" readonly="readonly"><%= expressao%></textarea></td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2"><table width="380" bgcolor="#DCE7DE">
                                                                        <tr>
                                                                            <td colspan="3" bordercolor="#DCE7DE" bgcolor="#333300"><div align="center" class="style34"><a href="javascript:window.location.href='editarexp.jsp?pai=variavel&nome=' + encode(document.logica.Nome.value) + '&expr=' + encode('<%=expressao%>')">Editar Express&atilde;o</a></div></td>
                                                                        </tr>
                                                                    </table></td>
                                                                </tr>
                                    <tr>
                                          ...
                                          <table width="150" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td width="60"><table width="60" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="variavel" type="radio" value="sim" onclick="window.location.href = 'variavelvalor_agente.jsp?nome='+Nome.value +'&expr='+ encode(Valor.value)">
                                                    </div></td>
                                              ...
                                              <td width="60"><table width="60" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="variavel" type="radio" onclick="window.location.href = 'variavelvalor.jsp?nome='+Nome.value +'&expr='+ encode(Valor.value)" value="n&atilde;o" checked>
                                                    </div></td>
