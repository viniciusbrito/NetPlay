...
<%@page import="interfaceNetLogo.*"%> 
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<%  
    //pasta onde os modelos a serem executados sao salvos temporariamente
    String pasta = "C:\\Lúcio\\ProjetoFinal\\web\\";
    
    int idModelo = Integer.parseInt(request.getParameter("id"));
    
    //compilando e salvando modelo
    String nomeArquivo = Execucao.salvarArquivo(idModelo, pasta);    
%>
