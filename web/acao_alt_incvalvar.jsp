...
<%
    ...
    IncrementarVariavel acao = (IncrementarVariavel) AplCadastrarAcao.obterAcao(
            Integer.parseInt(id));
    float incremento = acao.getIncremento().floatValue();
    int idVariavel = acao.getVariavel().getIdVariavel().intValue();
%>
...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/JavaScript">
            ...
            if (isNaN(val)) errors+='- Valor deve conter um numero.\n';
                        ...
                        <table width="500" border="1" bgcolor="#BBD0BF">
                            <tr>
                                <td height="127"><div align="center">
                                    <form action="controlador.ControladorWebCCA" method="post" name="acIncValVar" id="acIncValVar" onSubmit="MM_validateForm('incremento','','RisNum');return document.MM_returnValue">
                                        <table width="306" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                                    ...
                                                    <select name="variavel" id="var">
                                                        <%for(int i=0; i<vars1.size(); i++){
                                                                ...
                                                                if (var1.getTipo().compareTo("Logica") != 0) {
                                                                    if(idVariavel == var1.getIdVariavel().intValue()) {%>
                                            ...
                                            <tr>
                                                ...
                                                Valor</div></td>
                                                <td width="200"><div align="left">
                                                    <input name="incremento" type="text" id="inc" value="<%=incremento%>" size="10" maxlength="6">
                                                </div></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">&nbsp;</td>
