...
<%
    ...
    AlterarPosicao ac = (AlterarPosicao) acao;
    String agente = ac.getAgenteMovel().getNome();
    int posX = ac.getNovoX().intValue();
    int posY = ac.getNovoY().intValue();
...
<html>
    ...
    <div align="center">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td colspan="4"><div align="center" class="style38">Alterar Posição</div></td>
            </tr>
            <tr>
                <td colspan="4">&nbsp;</td>
            </tr>
