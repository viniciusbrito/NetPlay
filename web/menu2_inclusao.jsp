...
window.mm_menu_0510184332_0 = new Menu("root",136,18,"Arial, Helvetica, sans-serif",12,"#DCE7DE","#DCE7DE","#333300","#557D5C","center","middle",3,0,1000,-5,7,true,true,true,0,true,true);
  mm_menu_0510184332_0.addMenuItem("Incluir&nbsp;Variável","window.open('incluirvariavel.htm', 'principal');");
  ...
  mm_menu_0510184332_0.addMenuItem("Alterar&nbsp;Variável","window.open('controlador.ControladorWeb?metodo=pesquisaVariavel&acao=alteracao', 'principal');");
  mm_menu_0510184332_0.addMenuItem("Excluir&nbsp;Variável","window.open('controlador.ControladorWeb?metodo=pesquisaVariavel&acao=exclusao', 'principal');");
...
window.mm_menu_0510184627_0 = new Menu("root",135,18,"Arial, Helvetica, sans-serif",12,"#DCE7DE","#DCE7DE","#333300","#557D5C","center","middle",3,0,1000,-5,7,true,true,true,0,true,true);
  ...
  mm_menu_0510185111_0.addMenuItem("Incluir&nbsp;Gráfico","window.open('incluirgrafico.jsp', 'principal');");
  ...
  mm_menu_0510185111_0.addMenuItem("Alterar&nbsp;Gráfico","window.open('controlador.ControladorWeb?metodo=pesquisaPlot&acao=alteracao', 'principal');");
  mm_menu_0510185111_0.addMenuItem("Excluir&nbsp;Gráfico","window.open('controlador.ControladorWeb?metodo=pesquisaPlot&acao=exclusao', 'principal');");
...
window.mm_menu_0510185825_0 = new Menu("root",163,18,"Arial, Helvetica, sans-serif",12,"#DCE7DE","#DCE7DE","#333300","#557D5C","center","middle",3,0,1000,-5,7,true,true,true,0,true,true);
  mm_menu_0510185825_0.addMenuItem("Incluir&nbsp;Composição","window.open('incluircompantes.jsp', 'principal');");
  ...
  mm_menu_0510185825_0.addMenuItem("Alterar&nbsp;Composição","window.open('controlador.ControladorWebCCA?metodo=pesquisaComp&acao=alteracao', 'principal');");
  mm_menu_0510185825_0.addMenuItem("Excluir&nbsp;Composição","window.open('controlador.ControladorWebCCA?metodo=pesquisaComp&acao=exclusao', 'principal');");
...
window.mm_menu_0510185826_0 = new Menu("root",163,18,"Arial, Helvetica, sans-serif",12,"#DCE7DE","#DCE7DE","#333300","#557D5C","center","middle",3,0,1000,-5,7,true,true,true,0,true,true);
  mm_menu_0510185826_0.addMenuItem("Incluir&nbsp;Botão","window.open('incluirbotao.jsp', 'principal');");
  mm_menu_0510185826_0.addMenuItem("Consultar&nbsp;Botão","window.open('controlador.ControladorWebCCA?metodo=pesquisaBotao&acao=consulta', 'principal');");
  mm_menu_0510185826_0.addMenuItem("Alterar&nbsp;Botão","window.open('controlador.ControladorWebCCA?metodo=pesquisaBotao&acao=alteracao', 'principal');");
  mm_menu_0510185826_0.addMenuItem("Excluir&nbsp;Botão","window.open('controlador.ControladorWebCCA?metodo=pesquisaBotao&acao=exclusao', 'principal');");
