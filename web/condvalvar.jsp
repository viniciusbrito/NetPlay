                                                        ...
                                                        <td><div align="center">
                                                            <table width="306" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2"><textarea name="expr" cols="30" rows="3" id="expressao" readonly="readonly"><%=expr%></textarea></td>
                                                                </tr>
                                                                <tr align="center">
                                                                    <td colspan="3" bgcolor="#333300"><div align="center" class="style34"><a href="javascript:window.location.href='editarexp.jsp?pai=condvalvar&var=' + document.valvar.variavel.value + '&expr=' + encode('<%= expr%>')">Editar Express&atilde;o</a></div></td>
