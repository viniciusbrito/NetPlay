...
<%
    ...
    RecuperarValorVariavel ac = (RecuperarValorVariavel) acao;
    expressao = ac.getExp();
    String variavel = ac.getVariavel().getNome();
    
    Agente agente = ac.getAgente();
    String nomeAgente = "";
    if(agente != null)
                                                ...
                                                <td width="200"><div align="left">
                                                    ...
                                                    <select name="var" id="var" disabled>
                                                        <%for(int i=0; i<vars1.size(); i++){
                                                                ...
                                                                if (var1.getNome().equals(variavel)) {%>
                                            ...
                                            <tr>
                                              ...
                                              <td colspan="2">
                                                <select name="tipo" disabled>
                                                  <% if (agente == null) { %>
                                                    <option value="1">Express&atilde;o Geral</option>
                                                  <% } else { %>
                                                    <option value="2">Express&atilde;o envolvendo vari&aacute;veis locais de algum agente</option>
                                                  <%} %>
                                                </select>											  </td>
                                            </tr>
                                            <% if (agente != null) { %>
