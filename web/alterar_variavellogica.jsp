...
valorLogico = request.getParameter("valorLogico");
...
<div align="center">
  <table width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="4"><div align="center" class="style38">Altera&ccedil;&atilde;o Vari&aacute;vel L&oacute;gica </div></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
                            ...
                            <table width="380" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                              ...
                              <tr>
                                ...
                                <select name="valorLogico" id="select4">
                                  <% if (valorLogico.compareTo("true") == 0){%>
                                    ...
                                    <table width="150" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="60"><table width="60" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
											...
											<%} else{ %>	
                                           <input name="variavel" type="radio" value="sim" onclick="window.location.href = 'alterar_variavellogica.jsp?nome='+ Nome.value + '&valorLogico=' + valorLogico.value + '&nomeAntigo=' + nomeAntigo.value  + '&nomeAgente=agente'">
										    <%}%>
                                              </div></td>
                                        ...
                                        <td width="60"><table width="60" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                            <tr>
                                              <td width="20"><div align="center">
											   <% if (nomeAgente != ""){%>
                                                  <input name="variavel" type="radio" value="n&atilde;o" onclick="window.location.href = 'alterar_variavellogica.jsp?nome='+ Nome.value + '&valorLogico=' + valorLogico.value + '&nomeAntigo=' + nomeAntigo.value + '&nomeAgente= '" >
										     <%} else{ %>	
                                                ...
                                                <div align="left">
                                                  <select name="Agente" id="escolha do agente">
                                                      <%for(int i=0; i<agentes.size(); i++){
														...
														<option selected value= <%=agente.getIdAgente()%>> <%=nomeAgente%></option>
														<%}else{%>
