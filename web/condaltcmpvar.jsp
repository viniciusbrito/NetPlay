...
id = request.getParameter("id"); //id da condicao
...
int idVar1 = Integer.parseInt(var1);
int idVar2 = Integer.parseInt(var2);
                          ...
                          <td><div align="center">
                            <table width="366" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                ...
                                <td colspan="2"><div align="left">
                                    <select name="var1" id="var1">
                                      <%for(int i=0; i<vars1.size(); i++){
                                            ...
                                            if (v.getIdVariavel().intValue() == idVar1) { %>
                                ...
                                <td colspan="2"><div align="left">
                                    <select name="var2" id="var2">
                                      <%for(int i=0; i<vars2.size(); i++){
                                              ...
                                              if(v.getIdVariavel().intValue() == idVar2) {%>
                                                    <option selected value= <%= v.getIdVariavel() %>> <%= v.getNome() %></option>
                                              <%} else {%>
                                                    <option value= <%= v.getIdVariavel() %>> <%= v.getNome() %></option>
                                      <%}}%>
                              ...
                              <tr>
                                ...
                                <td colspan="3"><textarea name="expressao"  cols="30" rows="3" id="expressao" readonly="readonly"><%=expressao%></textarea></td>
                              </tr>
                              <tr>
                                <td colspan="3" bordercolor="#DCE7DE" bgcolor="#333300"><div align="center" class="style34"><a href="javascript:window.location.href='editarexp.jsp?pai=altcondcmpvar&var1=' + document.ccmpvar.var1.value + '&var2=' + document.ccmpvar.var2.value + '&expr=' + encode('<%= expressao%>') + '&id=<%=id%>'">Editar Express&atilde;o</a></div></td>
                              </tr>
                              <tr>
                                <td colspan="3">&nbsp;</td>
                              </tr>
