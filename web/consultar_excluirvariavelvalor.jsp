...
nomeAgente = request.getParameter("agente");
...
<div align="center">
  ...
  Exclus&atilde;o Vari&aacute;vel Valor
  <%} else { %>
  Consulta Vari&aacute;vel Valor
  <%}%>
        </div>
      </div></td>
    </tr>
                              ...
                              <td><div align="center">
                                  <table width="380" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                    <tr>
                                      ...
                                      <td width="240"><input name="Nome" type="text" id="Nome4" value="<%=nome%>" size="40" disabled></td>
                                    </tr>
                                    <tr>
