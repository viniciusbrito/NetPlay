    ...
    <head>
        ...
        <script language="JavaScript" type="text/JavaScript">
            ...
            function expressao()
            {
                ...
                {
                    javascript:window.location.href='editarexp.jsp?pai=altacrecvalvar&expr=' + encode('<%=expressao%>') + '&var=' + document.acRecValVar.variavel.value + '&id=<%=id%>'
                }
                else
                {
                    javascript:window.location.href='editarexp.jsp?pai=altacrecvalvar&expr=' + encode('<%=expressao%>') + '&var=' + document.acRecValVar.variavel.value + '&id=<%=id%>' + '&agente=' + document.acRecValVar.agente.value;
                }
            }
            //-->
        </script>
                                    ...
                                    <td height="125"><div align="center">
                                        <table width="306" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td width="126" bgcolor="#333300"><div align="center" class="style34"><a href="">Validar Express&atilde;o </a></div></td> -->
                                            </tr>
                                            <tr>
                                                <td colspan="2">&nbsp;</td>
                                            </tr>
