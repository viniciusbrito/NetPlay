            ...
            <tr>
              ...
              <td width="140"><div align="center">
                  <table width="140" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                    <tr>
                      <td width="20"><div align="center">
                          <input name="variavel" type="radio" value="slider" checked>
                      </div></td>
                              ...
                              <td><div align="center">
                                  <table width="380" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                    <tr>
                                      ...
                                      <td width="240"><input name="Nome" type="text" id="Nome" size="40" maxlength="50"></td>
                                    </tr>
                                    <tr>
                                      <td> <div align="left">Valor Inicial </div></td>
                                      <td><input name="valorinicial" type="text" id="Valor Inicial" size="40" maxlength="30"></td>
                                    </tr>
                                    <tr>
                                      <td> <div align="left">Valor M&iacute;nimo </div></td>
                                      <td><input name="valorminimo" type="text" id="Valor Minimo" size="40" maxlength="30"></td>
                                    </tr>
                                    <tr>
                                      <td> <div align="left">Valor M&aacute;ximo </div></td>
                                      <td><input name="valormaximo" type="text" id="Valor Maximo" size="40" maxlength="30"></td>
                                    </tr>
                                    <tr>
                                      <td> <div align="left"></div>
                                      <div align="left">Incremento </div></td>
                                      <td><input name="incremento" type="text" id="Incremento" size="40" maxlength="30"></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">&nbsp;</td>
                                    </tr>
                                          ...
                                          <table width="150" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td width="60"><table width="60" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="variavel" type="radio" value="sim" disabled onclick="window.location.href = 'variavelslider_agente.jsp?nome='+ Nome.value + '&valorinicial='+ valorinicial.value + '&valorminimo='+ valorminimo.value + '&valormaximo='+ valormaximo.value + '&incremento='+ incremento.value">
                                                    </div></td>
