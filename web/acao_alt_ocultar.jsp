<%-- 
    Document   : acao_alt_ocultar
    Created on : 27/11/2014, 03:36:08
    Author     : vinicius
--%>
...
<%
    ...
    int idAgente = ((OcultarAgente) acao).getAgente().getIdAgente().intValue();
    ...
    <body>
        ...
        <div align="center">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="4"><div align="center" class="style38">Ocultar Elemento </div></td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
                        ...
                        <table width="500" border="1" bgcolor="#BBD0BF">
                            <tr>
                                <td height="103"><div align="center">
                                    <form action="controlador.ControladorWebCCA" method="post" name="acOcultar" id="acOcultar">
                                        <table width="306" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                            ...
                                            <tr>
                                                <td><div align="center">
                                                    ...
                                                    <input name="TipoAcao" type="hidden" id="TipoAcao" value="Ocultar">
                                                </div></td>
                                            </tr>
                                            <tr>
