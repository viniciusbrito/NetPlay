...
<%
   ...
   PararMovimento acao = (PararMovimento) AplCadastrarAcao.obterAcao(
           Integer.parseInt(id));
    ...
    <body>
        ...
        <div align="center">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="4"><div align="center" class="style38">Parar Movimento </div></td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                </tr>
                            ...
                            <tr>
                                <td height="103"><div align="center">
                                    <form action="controlador.ControladorWebCCA" method="post" name="acAltMov" id="acAltMov" onSubmit="MM_validateForm();return document.MM_returnValue">
                                        ...
                                        <input name="metodo" type="hidden" value="cadastroAcao">
                                        <input name="acao" type="hidden" value="alterar">
                                        <input name="TipoAcao" type="hidden" id="TipoAcao" value="PararMov">
                                  </form>
                                </div></td>
                            </tr>
                        </table>
