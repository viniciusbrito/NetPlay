...
String acao = "";
String totalPosicoes = request.getParameter("totalPosicoes"); //total de valores preenchidos na tela de posicoes especificas
int idAgente;
String status = "";
...
if (tipoQtdInicial == null  || tipoQtdInicial.equals("Num"))
    tipoQtdInicial = "0";
...
function validaQuantidade(quantidade){
	...
	if (isNaN(num)&&quantidade!=""){
		...
		document.movel.quantidadeInicial.value = "";
                return 0;
	}
        else if (num < 0)
        {
    ...
    <tr>
      <td><div align="center">
        <table width="520" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="4"><div align="center" class="style38">Altera&ccedil;&atilde;o Agente M&oacute;vel </div></td>
          </tr>
          <tr>
            <td colspan="4">&nbsp;</td>
          </tr>
                ...
                <tr>
                  <td><div align="center">
                    <table width="393" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <% if (tipoMovimento.equals("Passear")) { %>
                            <%if (posicao.compareTo("aleatorio") != 0) { %>
                                <td><form action="controlador.ControladorWeb" method="post" name="movel" id="movel" onSubmit="MM_validateForm('Nome','','R','quantidadeInicial','','RisNum','Angulo Minimo','','RinRange0:360','Angulo Maximo','','RinRange0:360','quantidadeInicial','','<%="RinRange" + totalPosicoes + ":" + totalPosicoes%>');return document.MM_returnValue">
                            <%} else {%>
                                <td><form action="controlador.ControladorWeb" method="post" name="movel" id="movel" onSubmit="MM_validateForm('Nome','','R','quantidadeInicial','','RisNum','Angulo Minimo','','RinRange0:360','Angulo Maximo','','RinRange0:360');return document.MM_returnValue">
                            <%}%>
                        <% } else { %>
                            <%if (posicao.compareTo("aleatorio") != 0) { %>
                                <td><form action="controlador.ControladorWeb" method="post" name="movel" id="movel" onSubmit="MM_validateForm('Nome','','R','quantidadeInicial','','RisNum','Angulo Reflexao','','RinRange0:90','quantidadeInicial','','<%="RinRange" + totalPosicoes + ":" + totalPosicoes%>');return document.MM_returnValue">
                            <%} else {%>
                                <td><form action="controlador.ControladorWeb" method="post" name="movel" id="movel" onSubmit="MM_validateForm('Nome','','R','quantidadeInicial','','RisNum','Angulo Reflexao','','RinRange0:90');return document.MM_returnValue">
                            <%}}%>
                            <table width="393" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="420">&nbsp;</td>
                                  ...
                                  <table width="393" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                    <tr>
                                      ...
                                      <td colspan="2"><div align="left">
                                        <input name="Nome" type="text" id="Nome" value="<%=nome%>" size="35">
                                      </div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <!--<tr>
                                      ...
                                      <td colspan="2"><input name="quantidadeInicial" type="text" id="Quantidade Inicial" value="<%=quantidadeInicial%>" size="35" onChange="validaQuantidade(quantidadeInicial.value)"></td>
                                    </tr>
                                    <tr>-->
                                    ...
                                    <tr>
                                                ...
                                                <table width="155" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                    <tr>
                                                        <td width="22"><div align="center">
                                                            <% if (tipoQtdInicial.equals("0")) {
                                                                if (tipoMovimento.equals("Passear")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="0" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=0' + '&tipoMovimento=Passear' + '&passo=1' + '&anguloMinimo=' + anguloMinimo.value +  '&anguloMaximo=' + anguloMaximo.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value" checked>
                                                                <% } else if (tipoMovimento.equals("Refletir")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="0" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=0' + '&tipoMovimento=Refletir' + '&anguloReflexao=' + anguloReflexao.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value" checked>
                                                                <% } else if (tipoMovimento.equals("Parado")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="0" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=0' + '&tipoMovimento=Parado' + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value" checked>
                                                            <% } } else {
                                                                if (tipoMovimento.equals("Passear")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="0" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=0' + '&tipoMovimento=Passear' + '&passo=1' + '&anguloMinimo=' + anguloMinimo.value +  '&anguloMaximo=' + anguloMaximo.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value">
                                                                <% } else if (tipoMovimento.equals("Refletir")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="0" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=0' + '&tipoMovimento=Refletir' + '&anguloReflexao=' + anguloReflexao.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value">
                                                                <% } else if (tipoMovimento.equals("Parado")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="0" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=0' + '&tipoMovimento=Parado' + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value"> 
                                                                <% } } %>
                                                      </div></td>
                                                    ...
                                                    <tr>
                                                        <td width="22"><div align="center">
                                                            <% if (tipoQtdInicial.equals("1")) {
                                                                posicao = "aleatorio";
                                                                if (tipoMovimento.equals("Passear")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="1" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=1' + '&tipoMovimento=Passear' + '&passo=1' + '&anguloMinimo=' + anguloMinimo.value +  '&anguloMaximo=' + anguloMaximo.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value" checked>
                                                                <% } else if (tipoMovimento.equals("Refletir")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="1" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=1' + '&tipoMovimento=Refletir' + '&anguloMaximo=' + anguloReflexao.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value" checked>
                                                                <% } else { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="1" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=1' + '&tipoMovimento=Parado' + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value" checked>
                                                            <% } } else {
                                                                if (tipoMovimento.equals("Passear")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="1" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=1' + '&tipoMovimento=Passear' + '&passo=1' + '&anguloMinimo=' + anguloMinimo.value +  '&anguloMaximo=' + anguloMaximo.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value">
                                                                <% } else if (tipoMovimento.equals("Refletir")) { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="1" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=1' + '&tipoMovimento=Refletir' + '&anguloReflexao=' + anguloReflexao.value + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value">
                                                                <% } else { %>
                                                                    <input name="tipoQtdInicial" type="radio" value="1" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&tipoQtdInicial=1' + '&tipoMovimento=Parado' + '&tipoPosicao=<%=posicao%>' + '&idAgente=' + idAgente.value"> 
                                                            <% } } %>
                                                      </div></td>
                                                        <td width="126"><div align="center" class="style1">
                                            ...
                                            <td colspan="2" align="middle">
                                                <% if (tipoQtdInicial.equals("0")) { %>
                                                    <input name="quantidadeInicial" id="Quantidade Inicial" type="text" value="<%=quantidadeInicial%>" size="35" maxlength="10" onChange="validaQuantidade(quantidadeInicial.value)">
                                                <% } else { %>
                                                    ...
                                                    <div align="center"><select name="quantidadeInicial" id="Quantidade Inicial">
                                                           <% for(int i=0; i<variaveis.size(); i++){
		                                                        Variavel variavel = (Variavel)variaveis.get(i); 
                                                                        System.out.println (quantidadeInicial + " " + variavel.getIdVariavel());
                                                                        if (quantidadeInicial.length() > 0 && quantidadeInicial.equals(variavel.getIdVariavel().toString())) { %>
							...
							<%if(tipoMovimento.compareTo("Passear")==0){%>
                                                            <%if(posicao.compareTo("aleatorio")==0){%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&anguloMinimo=' + anguloMinimo.value + '&anguloMaximo=' + anguloMaximo.value  + '&idAgente=' + idAgente.value +  '&tipoMovimento=Passear' + '&tipoPosicao=aleatorio'" value="aleatorio" checked>
                                                            <%}else{%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&anguloMinimo=' + anguloMinimo.value +  '&anguloMaximo=' + anguloMaximo.value + '&idAgente=' + idAgente.value + '&tipoMovimento=Passear' + '&tipoPosicao=aleatorio'" value="aleatorio">                                                            
							<%}} else if(tipoMovimento.compareTo("Refletir")==0) {%>
                                                            <%if(posicao.compareTo("aleatorio")==0){%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + idAgente.value +  '&tipoMovimento=Refletir' +'&anguloReflexao=' + anguloReflexao.value + '&tipoPosicao=aleatorio'" value="aleatorio" checked>
                                                            <%} else {%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + idAgente.value + '&anguloReflexao=' + anguloReflexao.value + '&tipoMovimento=Refletir' +  '&tipoPosicao=aleatorio'" value="aleatorio">
                                                        <%}}  else {%>
                                                            <%if(posicao.compareTo("aleatorio")==0){%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + idAgente.value +  '&tipoMovimento=Parado' + '&tipoPosicao=aleatorio'" value="aleatorio" checked>
                                                            <%} else {%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + idAgente.value + '&tipoMovimento=Parado' +  '&tipoPosicao=aleatorio'" value="aleatorio">
                                                        <%}}%>
                                                      </div></td>
                                              ...
                                              <% if (tipoQtdInicial.length() > 1 || tipoQtdInicial.equals("0")) { %>
                                              <tr>
                                                <th scope="row">&nbsp;</th>
 							...
 							<%if(tipoMovimento.compareTo("Passear")==0){%>
                                                            <%if(posicao.compareTo("posicaoInicial")==0){%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&anguloMinimo=' + anguloMinimo.value +  '&anguloMaximo=' + anguloMaximo.value + '&idAgente=' + idAgente.value + '&tipoMovimento=Passear' + '&tipoPosicao=posicaoInicial'" value="posicaoInicial" checked>
                                                            <%}else{%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&anguloMinimo=' + anguloMinimo.value +  '&anguloMaximo=' + anguloMaximo.value + '&idAgente=' + idAgente.value + '&tipoMovimento=Passear' + '&tipoPosicao=posicaoInicial'" value="posicaoInicial">
                                                            <%}%>
                                                        <%}else if(tipoMovimento.compareTo("Passear")==0){%>
                                                            <%if(posicao.compareTo("posicaoInicial")==0){%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&anguloReflexao=' + anguloReflexao.value + '&idAgente=' + idAgente.value +  '&tipoMovimento=Refletir' + '&tipoPosicao=posicaoInicial'" value="posicaoInicial" checked>
                                                            <%}else{%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&anguloReflexao=' + anguloReflexao.value + '&idAgente=' + idAgente.value + '&tipoMovimento=Refletir' + '&tipoPosicao=posicaoInicial'" value="posicaoInicial">
                                                            <%}%>
                                                        <%}else {%>
                                                            <%if(posicao.compareTo("posicaoInicial")==0){%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + idAgente.value +  '&tipoMovimento=Parado' + '&tipoPosicao=posicaoInicial'" value="posicaoInicial" checked>
                                                            <%}else{%>
                                                                <input name="posicao" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + idAgente.value + '&tipoMovimento=Parado' + '&tipoPosicao=posicaoInicial'" value="posicaoInicial">
                                                            <%}}%>
                                                      </div></td>
                                                      <td width="230"><div align="center" class="style1">
                                    ...
                                    <tr>
									  ...
									  <table width="120" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td bgcolor="#333300"><div align="center" class="style1"><a href="javascript:if(validaQuantidade(document.movel.quantidadeInicial.value) == 1) window.location = 'selecionar_posicoesMovel.jsp?nome='+ document.movel.Nome.value + '&cor=' + document.movel.cor.value + '&acao=' + document.movel.acao.value + '&tamanho=' + document.movel.Tamanho.value + '&forma=' + document.movel.Forma.value + '&numeroQtdInicial=' + document.movel.quantidadeInicial.value + '&quantidadeInicial=' + <%=tipoQtdInicial%> + '&anguloMinimo=' + document.movel.anguloMinimo.value +  '&anguloMaximo=' + document.movel.anguloMaximo.value + '&idAgente=' + document.movel.idAgente.value + '&tipoMovimento=Passear' + '&totalPosicoes=<%=totalPosicoes%>'">Escolher Posi&ccedil;&otilde;es</a> </div></td>
                                          </tr>
                                      </table>
									  <%}else if(tipoMovimento.compareTo("Refletir")==0){%>
									  <table width="120" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td bgcolor="#333300"><div align="center" class="style1"><a href="javascript:if(validaQuantidade(document.movel.quantidadeInicial.value) == 1) window.location = 'selecionar_posicoesMovel.jsp?nome='+ document.movel.Nome.value + '&cor=' + document.movel.cor.value + '&acao=' + document.movel.acao.value + '&tamanho=' + document.movel.Tamanho.value + '&forma=' + document.movel.Forma.value + '&anguloReflexao=' + document.movel.anguloReflexao.value + '&numeroQtdInicial=' + document.movel.quantidadeInicial.value + '&quantidadeInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + document.movel.idAgente.value +'&tipoMovimento=Refletir' + '&totalPosicoes=<%=totalPosicoes%>'">Escolher Posi&ccedil;&otilde;es</a> </div></td>
                                          </tr>
                                      </table>
                                                                          <%}else{%>
									  <table width="120" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td bgcolor="#333300"><div align="center" class="style1"><a href="javascript:if(validaQuantidade(document.movel.quantidadeInicial.value) == 1) window.location = 'selecionar_posicoesMovel.jsp?nome='+ document.movel.Nome.value + '&cor=' + document.movel.cor.value + '&acao=' + document.movel.acao.value + '&tamanho=' + document.movel.Tamanho.value + '&forma=' + document.movel.Forma.value + '&numeroQtdInicial=' + document.movel.quantidadeInicial.value + '&quantidadeInicial=' + <%=tipoQtdInicial%> + '&idAgente=' + document.movel.idAgente.value +'&tipoMovimento=Parado' + '&totalPosicoes=<%=totalPosicoes%>'">Escolher Posi&ccedil;&otilde;es</a> </div></td>
                                          </tr>
                                      </table>
									  <%}%>
									  </td>
                                            ...
                                            <tr>
                                              <td width="75"><table width="75" height="5" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20">
												<%if(tipoMovimento.compareTo("Passear")==0){%>
												<input name="tipoMovimento" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value  + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&tipoMovimento=Passear' + '&idAgente=' + idAgente.value  + '&tipoPosicao=<%=posicao%>'" value="Passear" checked>
												 <%}else{%>
												 <input name="tipoMovimento" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&tipoMovimento=Passear' + '&idAgente=' + idAgente.value + '&tipoPosicao=<%=posicao%>'" value="Passear">
												 <%}%>
												</td>
                                              ...
                                              <td width="70"><table width="70" height="5" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                ...
                                                <input name="tipoMovimento" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&tipoMovimento=Refletir' + '&idAgente=' + idAgente.value + '&tipoPosicao=<%=posicao%>'" value="Refletir" checked>
   											 <%}else{%>
                                                <input name="tipoMovimento" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&tipoMovimento=Refletir' + '&idAgente=' + idAgente.value + '&tipoPosicao=<%=posicao%>'" value="Refletir">
												<%}%>
                                                    </div></td>
                                              ...
                                              <td width="70"><table width="70" height="5" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                ...
                                                <input name="tipoMovimento" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&tipoMovimento=Parado' + '&idAgente=' + idAgente.value + '&tipoPosicao=<%=posicao%>'" value="Parado" checked>
   											 <%}else{%>
                                                <input name="tipoMovimento" type="radio" onclick="window.location.href = 'alterar_movel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoQtdInicial=' + <%=tipoQtdInicial%> + '&tipoMovimento=Parado' + '&idAgente=' + idAgente.value + '&tipoPosicao=<%=posicao%>'" value="Parado">
												<%}%>
                                                    </div></td>
  											...
  											<%if(tipoMovimento.compareTo("Passear")==0){%>
                                                 <table width="250" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td><input name="anguloMinimo" type="text" id="Angulo Minimo" value="<%=anguloMinimo%>" size="20"></td>
                                                    </tr>
                                                    <tr>
                                                      <td><div align="left">&Acirc;ngulo M&aacute;ximo </div></td>
                                                      <td><input name="anguloMaximo" type="text" id="Angulo Maximo" value="<%=anguloMaximo%>" size="20"></td>
                                                    </tr>
                                                  </table>
												  <%}if(tipoMovimento.compareTo("Refletir")==0){%>
												  <table width="250" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td width="120"><input name="anguloReflexao" type="text" id="Angulo Reflexao" value="<%=anguloReflexao%>" size="20"></td>
                                                    </tr>
                                                  </table>
												  <%}%>
                                              </div></td>
                                    ...
                                    <tr>
                                      <td colspan="3"><div align="center">
                                          <input name="alteraragente" type="submit" id="alteraragente" value="Alterar Agente">
                                      </div></td>
                                    </tr>
                                  </table>
                                  </div></td>
                              ...
                              <tr>
                                <td><div align="center">
                                    <input name="passo" type="hidden" value="1">
