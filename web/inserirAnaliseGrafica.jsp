...
<div align="center">
  ...
  <% String idModelo = request.getParameter("idModelo");
     ...
     String pagina = "inserirAnaliseGrafica.jsp?anexou=1" + 
             "&idModelo=" + idModelo +
             "&idUsuario=" + idUsuario;
  ...
  <%
                    ...
                    { 
                        ...
                        String nomeArquivo = 
                                cgt.APICadastrarAnaliseGraficos.incluirNovaAnalise(
                                Integer.parseInt(idModelo), 
                                Integer.parseInt(idUsuario), item);
                        
                        //Chamando pagina que trata os dados dos graficos
  %>
                        <jsp:forward page = "analisandografico.jsp" >
                            <jsp:param name = "id" value = "<%= idModelo %>" />
