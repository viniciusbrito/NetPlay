          ...
          <tr>
            ...
            <td width="190"><div align="center">
                <table width="190" height="20" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                  <tr>
                    <td width="20"><div align="center">
                        <input name="agente" type="radio" onclick="window.location.href = 'estacionarioaleatorio.jsp'" value="aleatorio" checked>
                    </div></td>
                              ...
                              <table width="430" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                <tr>
                                  ...
                                  <td colspan="2"><div align="left">
                                    <input name="Nome" type="text" id="Nome" value="<%=nome%>" size="40" maxlength="30">
                                  </div></td>
                                </tr>
                                <tr>
                                  <td width="186">
                                ...
                                <tr>
                                  ...
                                  <td colspan="2">
                                    <div align="left">
                                      <input name="grauDispersao" type="text" id="Grau de Dispersao" value="<%=grauDispersao%>" size="10" maxlength="3">
                                  </div></td>
                                </tr>
								<%}%>
                                <tr>
                                          ...
                                          <tr>
                                            ...
                                            <th width="190" scope="row"><table width="190" height="20" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                              <tr>
                                                <td width="20"><div align="center">
												<%if(posicao==1){%>
                                                  <input name="posicao" type="radio" onclick="window.location.href = 'estacionarioaleatorio.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&posicao=1'" value="aleatorio" checked>
												   <%}else{%> 
													<input name="posicao" type="radio" onclick="window.location.href = 'estacionarioaleatorio.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&posicao=1'" value="aleatorio"> 
													<%}%>
                                                </div></td>
                                                <td width="230"><div align="center" class="style1">
                                            ...
                                            <th scope="row"><table width="190" height="20" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                              <tr>
                                                <td width="20" height="16"><div align="center">
                                                    <%if(posicao == 3){%>
                                                    <input name="posicao" type="radio" onclick="window.location.href = 'estacionarioaleatorio.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&posicao=3'" value="posicaoInicial" checked>
                                                    <%}else{%>
                                                    <input name="posicao" type="radio" onclick="window.location.href = 'estacionarioaleatorio.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&posicao=3'" value="posicaoInicial" >
                                                    <%}%>
                                                </div></td>
                                                <td width="230"><div align="center" class="style1">
								...
								<%if(posicao==3){%>
                                <tr>
                                  <td height="10" colspan="3"><table width="120" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <!--<td bgcolor="#333300"><div align="center" class="style1" onclick="window.location.href = 'selecionar_posicoes.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&acao=' + acao.value" ><a href="#">Escolher Posi&ccedil;&otilde;es</a> </div></td>-->
                                      <td bgcolor="#333300"><div align="center" class="style1" ><a href="javascript:window.location = 'selecionar_posicoes.jsp?nome='+ document.aleatorio.Nome.value + '&cor=' + document.aleatorio.cor.value + '&acao=' + document.aleatorio.acao.value">Escolher Posi&ccedil;&otilde;es</a> </div></td>
                                    </tr>
                                  </table>
                                ...
                                <tr>
                                  <td colspan="3"><div align="center">
                                    <input name="salvaragente" type="submit" id="salvaragente2" value="Salvar Agente">
</div></td>
                                </tr>
                              </table>
                            </div></td>
