<%-- 
    Document   : incluirbotao
    Created on : 12/12/2014, 14:17:45
    Author     : vinicius
--%>
        ...
        <div align="center">
            <form action="controlador.ControladorWebCCA" method="post" name="incComp" id="incComp" onSubmit="MM_validateForm('nome','','R');return document.MM_returnValue">
                <table border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <th width="480" colspan="2" scope="col"><div align="center" class="style38">Inclus&atilde;o de Bot&otilde;es </div></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2"><table width="480" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <th width="82" scope="col"><div align="center">Bot&atilde;o:</div></th>
                    ...
                    <tr>
                        <td colspan="2"><div align="center">
                            <input name="salvarCond" type="submit" id="salvarCond" value="Salvar Bot&atilde;o">
                        </div></td>
                    </tr>
                    <tr>
                        <td colspan="2"><div align="center">
                            ...
                            <input name="tipo" type="hidden" value="botao">
                        </div></td>
                    </tr>
                    <tr>
