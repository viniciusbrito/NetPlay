                                          ...
                                          <table width="150" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td width="60"><table width="60" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="variavel" type="radio" onclick="window.location.href = 'variavelslider_agente.jsp'" value="sim" checked>
                                                    </div></td>
                                              ...
                                              <td width="60"><table width="60" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="variavel" type="radio" onclick="window.location.href = 'variavelslider.jsp?nome='+ Nome.value + '&valorinicial='+ valorinicial.value + '&valorminimo='+valorminimo.value + '&valormaximo='+valormaximo.value   + '&incremento='+incremento.value" value="n&atilde;o">
                                                    </div></td>
