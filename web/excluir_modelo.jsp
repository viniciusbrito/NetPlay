                ...
                <table width="80" height="25" border="1" cellpadding="0" cellspacing="0" bgcolor="#333300">
                  <tr>
                    <td><div align="center" class="style34"> </div>
                        <div align="center" class="style34"><a href="controlador.ControladorWeb?metodo=cadastroModelo&acao=excluirModelo&nome=<%=java.net.URLEncoder.encode(m.getNome(), "utf-8")%>" target="_parent">Excluir</a></div></td>
                  </tr>
                </table> 
                </div></td>
            </tr>
