   ...
   <% } else { 
    ...
    for (int i=0; i<condicoes.size(); i++)
    {
        ...
        if(condicao.getTipo().equals("Per"))
        {
            ...
            {
                agentePrincipal = AplCadastrarAgente.obterAgente(percepcao.getAgentePrincipal().getIdAgente());
            }
            break;
        }
        if(condicao.getTipo().equals("Pos"))
        {
            ...
            {
                agentePrincipal = AplCadastrarAgente.obterAgente(pos.getAgentePrincipal().getIdAgente());
                break;
            }
        }
    }
