...
totalPosicoes = request.getParameter("totalPosicoes");
                ...
                <tr>
                  <td><div align="center">
                    <table width="393" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                      <%if (posicao == 3) { %>
                        <td><form action="controlador.ControladorWeb" method="post" name="movel" id="movel" onSubmit="MM_validateForm('Nome','','R','numeroQtdInicial','','RisNum','Angulo Reflexao','','RinRange0:90','numeroQtdInicial','','<%="RinRange" + totalPosicoes + ":" + totalPosicoes%>');return document.MM_returnValue">
                      <%} else {%>
                        <td><form action="controlador.ControladorWeb" method="post" name="movel" id="movel" onSubmit="MM_validateForm('Nome','','R','numeroQtdInicial','','RisNum','Angulo Reflexao','','RinRange0:90');return document.MM_returnValue">
                      <%}%>
                            <table width="393" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="420">&nbsp;</td>
                              ...
                              <tr>
                                <td height="10"><div align="center">
                                  <table width="393" border="1" cellpadding="0" cellspacing="0" bgcolor="#DCE7DE">
                                    <tr>
                                      <td width="204"><div align="left">Nome</div></td>
                                    ...
                                    <tr>
                                      <td><div align="left">Tamanho</div></td>
                                      <td colspan="2"><div align="left">
                                    ...
                                    <!--<tr>
                                      ...
                                      <td colspan="2"><input name="quantidadeInicial" type="text" id="Quantidade Inicial" value="<%=quantidadeInicial%>" size="35" maxlength="10" onChange="validaQuantidade(quantidadeInicial.value)"></td>
                                    </tr>-->
                                   ...
                                   <tr>
                                                    ...
                                                    <tr>
                                                        <td width="22"><div align="center">
                                                            <% if (quantidadeInicial.equals("0")) { %>
                                                                <input name="quantidadeInicial" type="radio" value="0" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=0' + '&anguloReflexao=' + anguloReflexao.value + '&posicao=<%=posicao%>'" checked>
                                                            <% } else { %>
                                                                <input name="quantidadeInicial" type="radio" value="0" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=0' + '&anguloReflexao=' + anguloReflexao.value + '&posicao=<%=posicao%>'"> <% } %>
                                                      </div></td>
                                                    ...
                                                    <tr>
                                                        <td width="22"><div align="center">
                                                            <% if (quantidadeInicial.equals("1")) { %>
                                                                <input name="quantidadeInicial" type="radio" value="1" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=1' + '&anguloReflexao=' + anguloReflexao.value + '&posicao=<%=posicao%>'" checked>
                                                            <% } else { %>
                                                                <input name="quantidadeInicial" type="radio" value="1" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=1' + '&anguloReflexao=' + anguloReflexao.value + '&posicao=<%=posicao%>'"> <% } %>
                                                      </div></td>
                                                        <td width="126"><div align="center" class="style1">
                                                ...
                                                <th width="190" scope="row"><table width="190" height="20" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                    <tr>
                                                      <td width="20"><div align="center">
                                                          ...
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&anguloReflexao=' + anguloReflexao.value + '&posicao=1'" value="aleatorio" checked>
                                                          <%}else{%>
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&anguloReflexao=' + anguloReflexao.value + '&posicao=1'" value="aleatorio">
                                                          <%}%>
                                                      </div></td>
                                                      <td width="230"><div align="center" class="style1">
                                                ...
                                                <th scope="row"><table width="190" height="20" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                    <tr>
                                                      <td width="20" height="16"><div align="center">
                                                          <%if(posicao == 3){%>
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&anguloReflexao=' + anguloReflexao.value + '&posicao=3'" value="posicaoInicial" checked>
                                                          <%}else{%>
                                                          <input name="posicao" type="radio" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&anguloReflexao=' + anguloReflexao.value + '&posicao=3'" value="posicaoInicial">
                                                          <%}%>
                                                      </div></td>
                                                      <td width="230"><div align="center" class="style1">
                                    ...
                                    <tr>
                                      <td colspan="3"><table width="120" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <!--<td bgcolor="#333300"><div align="center" class="style1" onclick="window.location.href = 'selecionar_posicoesMovel.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&acao=' + acao.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&anguloReflexao=' + anguloReflexao.value + '&quantidadeInicial=' + quantidadeInicial.value + '&tipoMovimento=Refletir'" ><a href="#">Escolher Posi&ccedil;&otilde;es</a> </div></td>-->
                                          ...
                                          <table width="170" height="5" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                              <td width="75"><table width="75" height="5" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><input name="tipoMovimento" type="radio" onclick="window.location.href = 'movelpassear.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&acao=' + acao.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=<%=posicao%>'" value="Passear"></td>
                                              ...
                                              <td width="70"><table width="70" height="5" border="1" cellpadding="0" cellspacing="0" bordercolor="#DCE7DE" bgcolor="#333300">
                                                  <tr>
                                                    <td width="20"><div align="center">
                                                        <input name="tipoMovimento" type="radio" onclick="window.location.href = 'movelrefletir.jsp?nome='+ Nome.value + '&cor=' + cor.value + '&acao=' + acao.value + '&tamanho=' + Tamanho.value + '&forma=' + Forma.value + '&quantidadeInicial=<%=quantidadeInicial%>' + '&numeroQtdInicial=' + numeroQtdInicial.value + '&posicao=<%=posicao%>'" value="Refletir" checked>
                                                    </div></td>
                                              ...
                                              <td><div align="center">
                                                  <table width="250" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td width="120"><input name="anguloReflexao" type="text" id="Angulo Reflexao" value="<%=anguloReflexao%>" size="20" maxlength="2"></td>
                                                    </tr>
                                                  </table>
                                              </div></td>
                                            </tr>
